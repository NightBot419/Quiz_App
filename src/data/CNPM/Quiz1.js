export const sampleQuestions = [
    {
        ...
        options: [
            "Dựa vào yêu cầu phần mềm của khắc hàng",
    ...
    {
        id: 2,
        question: "Những phát biểu nào sau đây đúng về mô hình thác nước?",
        options: [
    ...
    {
        id: 17,
        question: "Mô hình MVC gồm đúng 3 thành phần, trong khi đó số lượng thành phần theo mô hình phân tầng thay đổi tuỳ theo từng phần mềm?",
        options: [
    ...
    },
    {
        ...
        options: [
            "Mô hình phát triển tiến hoá cần tương tác thường xuyên với khách hàng, trong khi đó Mô hình phân phối gia tăng KHÔNG cần tương tác thường xuyên với khách hàng",
            "Số lần lặp quy trình trong Mô hình phát triển tiến hoá là biết trước, trong khi số lần lặp quy trình trong Mô hình phân phối gia tăng là KHÔNG biết trước",
            "Mô hình phát triển tiến hoá chỉ cần có miêu tả phác thảo về phần mềm là có thể bắt đầu tiến hành dự án, trong khi đó để bắt đầu tiến hành dự án. Mô hình phân phổi gia tăng, chúng ta cần phải có yêu cầu rõ ràng về phần mềm",
        ],
        correctAnswer: null,
        explanation: "True"
    },
    ...
    {
        id: 40,
        question: "Những phát biểu nào sau đây là đúng liên quan đến công việc găng (critical task) và đường găng (critical path) trong phương pháp CPM??",
        options: [
            "Công việc gắng là các công việc có trữ lượng thời gian (thời gian tự do) lớn hơn 0",
            "Công việc găng là các công việc có trữ lượng thời gian (thời gian tự do) bằng 0",
            "Độ dài của đường găng trên trục thời gian chính là thời gian lớn nhất để hoàn thành dự án theo lịch trình",
            "Đường găng là đường dài nhất đi xuyên mạng đi từ thời điểm bắt đầu tới thời điểm kết thúc đi qua các công việc găng",
        ],
    ...
    },
    {
        ...
        options: [
            ...
            "Fan-in/Fan-out",
            "Số lượng lớp con trực tiếp (NOC – Number of Children)",
            "Chiều dài định danh (L – Length of identifiers)",
            "Độ phức tạp chu trình (CC - Cyclomatic complexity)",
            "Số lượng phương thức bị ghi đè của lớp cha ở lớp con (NOM – Number Of Overrided Methods)",
        ],
        correctAnswer: null,
